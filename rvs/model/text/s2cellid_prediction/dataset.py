...
class RVSDataset(torch.utils.data.Dataset):
...
def create_dataset(data_dir: Text,
           region: Text, s2level) -> Tuple[RVSDataset, RVSDataset,
                           RVSDataset, Dict[int, int]]:
  ...
  # Create RVS dataset.
  train_dataset = RVSDataset(train_ds, s2level, cellid_to_label)
  val_dataset = RVSDataset(valid_ds, s2level, cellid_to_label)
  test_dataset = RVSDataset(test_ds, s2level, cellid_to_label)
