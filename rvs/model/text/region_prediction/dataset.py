...
def create_dataset(data_dir: Text) -> Tuple[RVSDataset, RVSDataset, RVSDataset]:
  ...
  # Create rvs dataset.
  train_dataset = RVSDataset(train_encodings, train_labels)
  val_dataset = RVSDataset(val_encodings, val_labels)
  test_dataset = RVSDataset(test_encodings, test_labels)
