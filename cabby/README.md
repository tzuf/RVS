...
```
bazel-bin/cabby/data/metagraph/create_graph_embedding  --region REGION --s2_level LEVEL --s2_node_levels LEVEL --s2_node_levels LEVEL+1 --s2_node_levels LEVEL-1  --base_osm_map_filepath DIRECTORY_TO_MAP --save_embedding_path PATH_TO_SAVE_GRAPH --dimensions EMBED_DIM
```
